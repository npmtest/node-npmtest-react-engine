...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-engine/node_modules/react-engine/lib/util.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-engine/node_modules/react-engine/lib/util.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-engine/node_modules/react-engine/lib/</a> &#187; util.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function clearRequireCache(file) {</span>
...
<span class="fstat-no" title="function not covered" >function clearRequireCacheInDir(dir, extension) {</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  var files = glob.sync('**/*.' + extension, options);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  files.map(<span class="fstat-no" title="function not covered" >function(file) {</span></span>
<span class="cstat-no" title="statement not covered" >    clearRequireCache(dir + path.sep + (file.split(/\\|\//g).join(path.sep)));</span>
  });
}
&nbsp;
